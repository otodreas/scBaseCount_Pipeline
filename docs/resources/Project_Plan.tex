...
\textbf{Hypothesis:} scVI, scanpy, and scGPT integration will produce CyteType label assignments that differ from STATE annotations from the Arc Institute in a pattern measurable by concordance metrics for one or more datasets; whether integration improves or harms annotation consistency will be assessed per dataset and subset.
...
\begin{itemize}
    ...
    \item \textbf{Phase 4 (weeks 17–20):} scanpy and scGPT embeddings into CyteType versus scVI (Phases 2–3), compared to STATE annotations (Arc Institute).
\end{itemize}
