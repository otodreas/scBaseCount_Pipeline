...
The difference in magnitude between the aggregate batch correction and biological conservation scores suggest that Harmony has a greater impact in mixing batch labels than it does disrupting the graph. While this result may differ for different atlas datasets, Harmony has been shown to perform consistently at the level of foundation models such as scGPT and Geneformer, abeit more consistently, in particular when those foundation models are configured for zero-shot batch correction~\parencite{cuiScGPTBuildingFoundation2024,theodorisTransferLearningEnables2023,liuEvaluatingUtilitiesFoundation2026,kedzierskaZeroshotEvaluationReveals2025}.
