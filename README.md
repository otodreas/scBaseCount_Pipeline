...
| ---- | ------------------------------------------------------------------------------------------ | ----------------------------------------------------------------------------------------------------------------------------------- | -------------------------------------------------------------------------------------------------------- |
| 1    | Optional [notebooks/utility/single_srx_cluster_validation.ipynb](notebooks/utility/single_srx_cluster_validation.ipynb) | Interactive clustering-resolution figures; no h5ad or figure files written                                                         | `logs/cluster_validation.log`                                                                            |
