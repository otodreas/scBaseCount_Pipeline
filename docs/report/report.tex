...
To ensure datasets matched scBaseCount, we computed dataset MD5 hashes following download from R2 and compared them with the MD5 hashes stored as metadata alongside the corresponding R2 objects, the latter having been computed upon upload. This allowed us to verified upload and download hash identity.
