...
| [`annotation_inspector/`](annotation_inspector/) | `inspect_accession(...)`, `write_extremes_csv(...)` | Pair-level `summary.csv`, optional `umap_cells.parquet`, optional `extremes.csv` |
