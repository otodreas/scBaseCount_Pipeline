...
\paragraph*{S1 Fig.}
\label{S1_Fig}
\textbf{Leiden resolution sweeps for five cell-count quantile validation files.}
Pages 1--5 show SRX22996378, SRX12366723, SRX17412841, SRX24313469, and SRX13198730, corresponding to the 25th, 33rd, 50th, 67th, and 75th percentiles of cell count, respectively. On each page, A: UMAP of Leiden clusters at the Jaccard-selected resolution versus CZ CELLxGENE \texttt{cell_type} labels. B: Cluster and cell-type composition. C: Cluster count and matched Jaccard score across resolutions 0.1--1.9. D: Homogeneity, completeness, V-measure, NMI, and ARI versus resolution.
