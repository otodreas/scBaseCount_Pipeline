...
Building an integrated lung atlas using scBaseCount data required developing robust single-cell workflows in Python using Scanpy~\parencite{wolfSCANPYLargescaleSinglecell2018}.
...
Before datasets were compiled into 
