...
\section*{Results and discussion (TODO: integrate discussion-y clauses in results paragraphs)}
...
In terms of data processing, there is potential to deepen the methodology at nearly every level. In regards to the selection of HVGs, multiple methods exist for ranking genes, and the number of genes plays an important role in the downstream granularity of the cell embedding~\parencite{kiselevChallengesUnsupervisedClustering2019,zhaoSystematicEvaluationHighly2025}. In this study, we effectively left both unanswered by 
